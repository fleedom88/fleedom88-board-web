...
import { GetUserResponseDto, PatchNicknameResponesDto, PatchProfileImageResponseDto } from 'apis/response/user';
...
export default function User() {
  ...
  const UserTop = () => {
    ...
    const patchNicknameResponse = (responseBody: PatchNicknameResponesDto | ResponseDto | null ) => {
      if (!responseBody) return;
      const { code } = responseBody;
        ...
        <div className='user-bottom-container'>
          ...
          <div className='user-bottom-contents-box'>
            ...
            <div className='user-bottom-contents'>
              {viewList.map(boardListItem => <BoardItem boardListItem={boardListItem}></BoardItem>)}
            </div>
          }
